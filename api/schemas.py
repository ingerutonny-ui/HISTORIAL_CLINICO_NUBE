...
class AntecedentesCreate(BaseModel):
    paciente_id: int
    p1: str = "NO"; d1: Optional[str] = ""
    p2: str = "NO"; d2: Optional[str] = ""
    p3: str = "NO"; d3: Optional[str] = ""
    p4: str = "NO"; d4: Optional[str] = ""
    p5: str = "NO"; d5: Optional[str] = ""
    p6: str = "NO"; d6: Optional[str] = ""
    p7: str = "NO"; d7: Optional[str] = ""
    p8: str = "NO"; d8: Optional[str] = ""
    p9: str = "NO"; d9: Optional[str] = ""
    p10: str = "NO"; d10: Optional[str] = ""
    p11: str = "NO"; d11: Optional[str] = ""
    p12: str = "NO"; d12: Optional[str] = ""
