...
class AntecedentesP2(Base):
    ...
    p5 = Column(String); d5 = Column(String) # ... hasta p18 y d18
    p6 = Column(String); d6 = Column(String); p7 = Column(String); d7 = Column(String)
    p8 = Column(String); d8 = Column(String); p9 = Column(String); d9 = Column(String)
    p10 = Column(String); d10 = Column(String); p11 = Column(String); d11 = Column(String)
    p12 = Column(String); d12 = Column(String); p13 = Column(String); d13 = Column(String)
    p14 = Column(String); d14 = Column(String); p15 = Column(String); d15 = Column(String)
    p16 = Column(String); d16 = Column(String); p17 = Column(String); d17 = Column(String)
...
class HabitosRiesgosP3(Base):
    ...
    riesgos_vida_laboral = Column(String) # CAMPO CRÍTICO
