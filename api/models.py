...
class AntecedentesP2(Base):
    ...
    dermato = Column(String); alergias = Column(String)
    cirugias = Column(String); acc_trabajo = Column(String)
    acc_personales = Column(String); medicamentos = Column(String)
    infecciosas = Column(String); urinario = Column(String)
    endocrino = Column(String); linfatico = Column(String)
    familiares = Column(String); reumato = Column(String)
