...
# Configuración de FastAPI con redirección de barras activada
app = FastAPI(redirect_slashes=True)

# CORS TOTALMENTE ABIERTO PARA EVITAR BLOQUEOS
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# RUTA UNIFICADA (Sin prefijos complejos para evitar el 404 de Render)
@app.post("/guardar-p3")
